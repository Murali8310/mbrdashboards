...
.frame {
	...
	overflow: hidden;
	/* background: -webkit-linear-gradient(bottom left, #1F1B64 0%, #D0D0E4 100%); */
			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-12 d-flex no-block align-items-center">
						<h4 class="page-title display-5">Holiday Master Upload</h4>
...
<p  style="padding-top: 20px" > Note : Mobile number should start with +91 in Excel file  </p>
							<a id="selectedFileType"
								class="sidebar-link far sidebar-link dwn"
								href="downloadABMFormatFile"> <b><span
									class="hide-menu dwn" style="font-family: verdana"> 
										ABM Format File </span></b></a>
							<div class="center">
								<form id="example-form" method="post" class=""
									enctype="multipart/form-data">
									<div class="bar"></div>
...
var file = $('#file').val();
	...
	$(".loading").show();
		      $.ajax({
		        url: "uploadBulkholidayExcelFile",
		        type: "POST",
		        enctype: 'multipart/form-data',
