			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-12 d-flex no-block align-items-center">
						<h4 class="page-title  display-5" style="color: Teal">Employee
							Management</h4>
			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<c:forEach items="${listOfMenuNames}" var="menuNames">
						...
						<c:if test="${menuNames[0] =='Master Menu'}">
						...
						<c:if test="${menuNames[0] =='Sub Menu'}">
							<div class="col-md-6 col-lg-4 col-xlg-3">
								<div class="card card-hover">
									<a href="${menuNames[1]}">
						...
						<%--      <c:if test="${menuNames[0] =='Bulk User Upload'}">
                    <div class="col-md-6 col-lg-4 col-xlg-3">
                        <div class="card card-hover">
                           <a href="${menuNames[1]}">
                           <div class="box bg-success text-center">
                                <h1 class="font-light text-white"><i class="fa fa-upload"></i></h1>
                                <h6 class="text-white">${menuNames[0]}</h6>
                            </div>
                            </a> 
                        </div>
						...
						<c:if test="${menuNames[0] =='Change Password'}">
							<div class="col-md-6 col-lg-4 col-xlg-3">
								<div class="card card-hover">
									<a href="${menuNames[1]}">
						...
						<c:if test="${menuNames[0] =='User Logs'}">
							<div class="col-md-6 col-lg-4 col-xlg-3">
								<div class="card card-hover">
									<a href="${menuNames[1]}">
						...
						<div class="card card-hover">
							<a href="searchUID">
								<div class="box bg-warning text-center">
									...
									<h6 class="text-white">searchUID</h6>
								</div>
							</a>
						</div>
					</div>
						...
						<div class="card card-hover">
							<a href="CFATransDet">
								<div class="box bg-danger text-center">
									...
									<h6 class="text-white">CFATransDet</h6>
								</div>
							</a>
						</div>
					</div>
						...
						<div class="card card-hover">
							<a href="CFAReport">
								<div class="box bg-success text-center">
									...
									<h6 class="text-white">CFAReport</h6>
								</div>
							</a>
						</div>
					</div>
						...
						<div class="card card-hover">
							<a href="ReportAccess">
								<div class="box bg-danger text-center">
									...
									<h6 class="text-white">User Report Access</h6>
								</div>
							</a>
						</div>
					</div>
						...
						<div class="card card-hover">
							<a href="UsageReport">
								<div class="box bg-success text-center">
									...
									<h6 class="text-white">Usage Repor</h6>
								</div>
							</a>
						</div>
					</div>
