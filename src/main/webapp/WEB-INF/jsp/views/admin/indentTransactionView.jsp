...
//alert("1");
		...
		success : function(response) {
			...
			for (var i = 0; i < response.length; i++) {
				...
				/* const productImage = document
				 ...
				 var output = "<span class='title' style='padding: 2px;border-radius: 3px;'>Indent Number:</span> <span class='highlight1' style='padding: 2px;border-radius: 3px;'>" +  response[0][8]
					+ "</span> ";
	...
	function calculateTotal() {
		...
		var output = "<span class='title' style='padding: 2px;border-radius: 3px;' >Indent Value: ₹</span><span style='padding: 2px;border-radius: 3px;' class='highlight'>" + totalPrice
				+ "</span> <span style='padding: 2px;border-radius: 3px;' class='title'>Indent Qty:</span> <span style='padding: 2px;border-radius: 3px;' class='highlight'>" + totalQuantity
				+ "</span>";
