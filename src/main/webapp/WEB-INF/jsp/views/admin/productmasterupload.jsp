							...
							<div class="frame" style="top: 215px">
								...
								<div style="margin-top: 330px;">
									<a
										...
										href="downloadProductMastertFormatFile"> <b><span
											class="hide-menu" style="font-family: 'Montserrat'">
											    <i class="fas fa-download"></i>
												Product Master File </span></b></a>
								</div>
...
var file = $('#file').val();
	...
	$(".loading").show();
		      $.ajax({
		       ...
		       console.log(data)
	        	if(data == 'file upload successfully'){
	            ...
	            var errorMessageText = errorJSON.error;
	            console.log(data)
		        	Swal.fire({
		    			icon : 'warning',
		    			title : 'Budget Master',
